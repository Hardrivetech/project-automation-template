...
![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/your-username/project-automation-template/project-automation.yml?branch=main)
